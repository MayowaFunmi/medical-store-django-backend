...
from .models import Company, CompanyBank, Medicine, MedicalDetails, Employee, Customer, Bill, CustomerRequest, \
    CompanyAccount, EmployeeBank


class CompanySerializer(serializers.ModelSerializer): # or use HyperLinkedModelSerializer
    class Meta:
        model = Company
        fields = '__all__'
...
class CompanyBankSerializer(serializers.ModelSerializer):
    ...
    # display ForeignKey data rather than id
...
# Add another serializer to use multiple serializer in one viewset
